...
from src.userquotes import Ui_Form
...
def test_main_btn(ui_form):
    '''Test that the main button is correctly displayed'''
    assert ui_form.main_btn.text() == "Main Menu"
    assert ui_form.main_btn.font().family() == "Sura"
    assert ui_form.main_btn.objectName() == "main_btn" 
